(function ($) {
    ...
    aplandWindow.on('scroll', function () {
        if (aplandWindow.scrollTop() > 120) {
            $('.main_header_area').addClass('sticky slideInDown');
            $('.navbar-toggler>span').attr('class', 'navbar-toggler-icon');
            if ($('#navbar-logo').attr('src') !== '/assets/img/logo/logo-dark.svg') {
                $('#navbar-logo').attr('src', '/assets/img/logo/logo-dark.svg');
            }
        } else {
            $('.main_header_area').removeClass('sticky slideInDown');
            if ($('body').hasClass('slideshows')) {
                $('.navbar-toggler>span').attr('class', 'navbar-toggler-icon navbar-toggler-icon-light');
                if ($('#navbar-logo').attr('src') !== '/assets/img/logo/logo-light.svg') {
                    $('#navbar-logo').attr('src', '/assets/img/logo/logo-light.svg');
                }
            } else {
                $('.navbar-toggler>span').attr('class', 'navbar-toggler-icon');
                if ($('#navbar-logo').attr('src') !== '/assets/img/logo/logo-dark.svg') {
